---
title: "Predictive Modeling of Housing Prices in Seattle"
author: "Jiahang Li"
date: "2024-3-28"
output:
  html_document:
...
# Read and process burglaries 
burglaries <- st_read("C:/Users/jiahangl/OneDrive - PennO365/MUSA508/W8/burglaries.shp") %>% 
...
```{r read_data}
# Read and process police districts data
# Ensure the sf and dplyr packages are installed and loaded

# Load the packages
library(sf)
library(dplyr)

# Set the path to your SHP file
shp_path <- "C:/Users/jiahangl/OneDrive - PennO365/MUSA508/W8/burglaries.shp"

# Read the SHP file and transform the CRS
# Please adjust the path as per your system specifics
tryCatch({
  burglaries <- st_read(shp_path) %>% 
    st_transform(crs = 'ESRI:102271') # Ensure the crs argument is specified for clarity
}, error = function(e) {
...
# Optionally, print or inspect the first few rows to confirm successful transformation
head(burglaries)
...
#filterout cold spot: ifslese<=0.05
```
